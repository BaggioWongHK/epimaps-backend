...
/**
 * @description A quick reminder of how this works. The
 * root node is added to an array. This recurses, adding
 * children nodes to the array per recursion to the end
 * of the queue, while processing the first element of
 * the queue. Recursion stops when iteration stops.
 * Routine stops when queue is empty.
 * @return {*}
 */
Tree.prototype.print = function() {
    ...
    // var queue = [this.root, newline]; // original
    var queue = [this.root];
    var string = '';
    while(queue.length) {
        var node = queue.shift();
